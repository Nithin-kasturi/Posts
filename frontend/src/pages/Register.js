    ...
    <div class="flex flex-col items-center justify-center h-screen ">
            ...
            <div class="bg-white p-10 rounded-3xl">
                <div className='p-1'>
                    ...
                    <div className='flex flex-row mt-4'>
                        <input onChange={(e)=>setUserDetails({...userDetails,name:e.target.value})} className='text-center h-7 w-full rounded-xl text-sm border-2 border-black'  name="name" type='text' placeholder='Enter Name'/>
                    </div>
                    <h1 className='mt-4 text-blue-400'>Profile picture</h1>
                    <div className='flex flex-row mt-4'>
                        <input type="file" accept="image/*" className='text-sm' onChange={(e)=>setUserDetails({...userDetails,image:e.target.value})}/>
                    </div>
                    <h1 className='mt-4 text-blue-400'>Terms & Conditions:</h1>
                    <div className='flex flex-row mt-4'>
                        <input type="checkbox" />
                        <h1 className='pl-2 text-red-500'>You are submitting your email and password</h1>
                    </div>
                    ...
                    <div className='mt-3 flex flex-row text-sm justify-between text-md'>
                        ...
                        <Link className='text-[#f34848]' to='/login'>Login</Link>
                    </div>
                </div>
            </div>
    </div>
